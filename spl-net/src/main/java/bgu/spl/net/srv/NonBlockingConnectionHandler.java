...
public class NonBlockingConnectionHandler<T> implements ConnectionHandler<T> {
    ...
    public NonBlockingConnectionHandler(MessageEncoderDecoder<T> reader, StompMessagingProtocol protocol, SocketChannel chan,
                                        Reactor reactor, ConnectionsImpl connections, int connectionHandlerId) {
        this.chan = chan;
        this.encdec = reader;
